...
def load_data(messages_filepath, categories_filepath):
    '''
    Loads data from messages and categories file
    ...
    # set each value to be the last character of the string and converting to int
...
def clean_data(df):
    '''
    Removes deuplicates from data frame
    param: df
    return: df
    '''
